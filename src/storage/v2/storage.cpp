...
Storage::Storage(Config config)
  ...
  //aeong cloud thread
  std::chrono::milliseconds cloud_interval{std::chrono::seconds(10)};
  // std::chrono::milliseconds cloud_interval{std::chrono::minutes(1)};
  cloud_storage_runner_.Run("RocksdbCloudSave", cloud_interval, [this] { this->MigrateToRocksDBCloudStorage(); });
...
bool Storage::MigrateToRocksDBCloudStorage(){
  return saved_history_deltas_->MigrateToRocksDBCloud();
}
